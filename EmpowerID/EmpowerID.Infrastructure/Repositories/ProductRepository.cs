...
namespace EmpowerID.Infrastructure.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<List<Product>> SearchProductsAsync(string? productName, int? categoryId, decimal? minPrice, decimal? maxPrice, string? description, DateTime? addedAtStart, DateTime? addedAtEnd, int take, int skip)
        {
            //tested connection
            ...
            var products = await _dbContext.Products
                    ...
                    productName, categoryId, minPrice, maxPrice, description, addedAtStart, addedAtEnd, take, skip)
                    .ToListAsync();
